...
class Velux : public BaseLib::Systems::DeviceFamily
{
public:
	Velux(BaseLib::SharedObjects* bl, BaseLib::Systems::IFamilyEventSink* eventHandler);
    Velux(const Velux&) = delete;
    Velux& operator=(const Velux&) = delete;
